...
$a = array(
1 => array(
   0 => "You can add a row using SQL in a database with which of the following?",
   1 => "ADD",
   2 => "CREATE",
   3 => "INSERT",
   4 => "MAKE",
...
2 => array(
   0 => "The command to remove rows from a table \'CUSTOMER\' is:",
...
4 => array(
   0 => "Which of the following is the original purpose of SQL?",
...
5 => array(
   0 => "The wildcard in a WHERE clause is useful when? ",
...
6 => array(
   0 => "A view is which of the following?",
...
7 => array(
   0 => "The command to eliminate a table from a database is:",
...
8 => array(
   0 => "ON UPDATE CASCADE ensures which of the following?",
   1 => "Normalization",
   2 => "Data Integrity",
...
9 => array(
   0 => "SQL data definition commands make up a(n) ________ .",
   1 => "DDL",
   2 => "DML",
   3 => "HTML",
   4 => "XML",
...
10 => array(
   0 => "Which of the following is valid SQL for an Index?",
   1 => "CREATE INDEX ID;",
   2 => "CHANGE INDEX ID;",
   3 => "ADD INDEX ID;",
   4 => "REMOVE INDEX ID;",
