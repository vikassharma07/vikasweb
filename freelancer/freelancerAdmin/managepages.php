...
<body>
	...
	$result=mysql_query($query);
?>
	<h1><b>MANAGE PAGES</b></h1>
	<div style="text-align:right:padding-left:55px" >
			
            	<h4><a href="addpages.php">Add pages</a></h4>
					 </div></br>
	...
	<tr>
				...
				<th class="table-header-repeat line-left minwidth-1"><a href="">Pagename</a>	</th>
					<th class="table-header-repeat line-left minwidth-1"><a href="">SEO title</a></th>
					<th class="table-header-repeat line-left"><a href="">SEO keyword</a></th>
					<th class="table-header-repeat line-left"><a href="">SEO description</a></th>
					<th class="table-header-repeat line-left"><a href="">Detail</a></th>
	...
	<?php
		...
		<td><a href="editpage.php?id=<?php echo $id;?>" class="icon-1 info-tooltip"></a> <a href="delete.php?id=<?php echo $id;?>"class="icon-2 info-tooltip"></a></td>
